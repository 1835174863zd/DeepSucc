...
history = lstm_model.fit(train_X,train_y,batch_size=512,epochs=600,validation_split=0.3,verbose=2)
...
for train, test in kfold.split(train_X, train_y):
    ...
    lstm_model.fit(train_X[train], train_y[train], batch_size=32,epochs=600, verbose=0)
    # evaluate the model
...
dataframe.to_csv("BLOSUM62_CNN_LSTM.csv",index=False,sep=',')
