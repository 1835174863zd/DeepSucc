...
# # 2、数据处理(准备训练数据)
# data_=pd.read_csv(r'aaindex_General_Train.csv')
# data=np.array(data_)
# #数据1：1
# data = np.concatenate((data[0:9638,1:],data[9638:19276,1:]),axis=0)
...
train_X,train_y=get_shuffle(aaindex_data,y_)
...
dataframe.to_csv("AAindex_LSTM_CNN.csv",index=False,sep=',')
