...
kw=  {'path': r"../../data/Train.csv",}
fastas1 = readFasta.readFasta(r"../../data/Train.csv")
print(fastas1)
print(kw)

result=BLOSUM62(fastas1, **kw)
result = np.array(result)
BLOSUM62_data = result[1:,1:]
BLOSUM62_data = scale(BLOSUM62_data)
with open('BLOSUM62_Traindata.csv', 'w', newline='') as csvfile:
	writer = csv.writer(csvfile)
	for row in BLOSUM62_data:
		writer.writerow(row)
