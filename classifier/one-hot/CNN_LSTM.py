...
history = lstm_model.fit(train_X,train_y,batch_size=128,epochs=300,validation_split=0.3,verbose=2)
...
for train, test in kfold.split(train_X, train_y):
    ...
    lstm_model.fit(train_X[train], train_y[train], batch_size=128,epochs=200, verbose=0)
    # evaluate the model
...
dataframe.to_csv("onehoe_CNN_LSTM.csv",index=False,sep=',')
